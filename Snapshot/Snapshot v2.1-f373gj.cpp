...
void sysinfo()
{
	...
	cout << "**************************" << endl;
	cout << "版本：Snapshot v2.1-f373gj 构建时间：2022-12-30" << endl;
}
double cal(double x , double y , char op) // 计算器模块 
{
...
bool cmp(double x , double y) //快速排序sort语句比较规则模块 
{
	return x > y; 
}
void qsort(int num)
